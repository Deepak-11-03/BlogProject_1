...
const getBlogs = async function (req, res) {
    try {
        ...
        if (!(queryData.subcategory || queryData.category || queryData.tags || queryData.authorId)) {
        ...
        if (queryData.tags) {
            queryData.tags = queryData.tags.toLowerCase().trim()  // remove the space in tags and save in lowecase
        }
        if (queryData.subcategory) {
            queryData.subcategory = queryData.subcategory.toLowerCase().trim()   // remove the space in subcategory and save in lowecase
        }
        // for array data like tags and subcategory
